...
// 1. Sayfa yüklenir yüklenmez (hiç beklemeden) durumu kontrol et
if (localStorage.getItem("menuOpen") === "true" && window.innerWidth <= 1024) {
    navLinks.classList.add("show");
}

if (menuToggle && navLinks) {
    // 2. Butona basıldığında durumu değiştir ve kaydet
    menuToggle.addEventListener("click", () => {
        navLinks.classList.toggle("show");
        
        // Yeni durumu kaydet (açıksa true, kapalıysa false)
